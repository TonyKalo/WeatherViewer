package androidcall.sip.call.weatherviewer.ui.weather_main.paris;
...
public class ParisWeatherPresenter<V extends WeatherMvpView> extends BasePresenter<V> implements WeatherMvpPresenter<V>,Runnable {

    private Handler handler;


    @Inject
    public ParisWeatherPresenter(DataManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable, Handler handler) {
    ...
    public void onViewCreated() {
        WeatherMainInfo weatherMainInfo = getDataManager().getWeatherByCityFromDb("Paris");
    ...
    private void getLondonData(){
        ...
        getCompositeDisposable().add(getDataManager().getWeather("Paris",AppConstants.MAIN_UNIT, AppConstants.APPID).
