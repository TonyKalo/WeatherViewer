...
public class BerlinWeatherPresenter<V extends WeatherMvpView> extends BasePresenter<V> implements WeatherMvpPresenter<V>,Runnable {

    private Handler handler;


    @Inject
    public BerlinWeatherPresenter(DataManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable, Handler handler) {
    ...
    public void onViewCreated() {
        WeatherMainInfo weatherMainInfo = getDataManager().getWeatherByCityFromDb("Berlin");
    ...
    private void getLondonData(){
        ...
        getCompositeDisposable().add(getDataManager().getWeather("Berlin",AppConstants.MAIN_UNIT, AppConstants.APPID).
